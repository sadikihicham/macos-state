...
- **مخططات الاتجاهات** (تاريخ المعالج / الذاكرة / الحرارة لآخر ~3 دقائق) في الوضع المُوسّع — محلي بالكامل.
- **قراءة مباشرة في شريط القوائم**: مقياس مختار (المعالج / الذاكرة / الحرارة) بجوار الأيقونة مع مخطط مصغّر — بنظرة واحدة، محلي بالكامل.
- **تنبيهات العتبة**: إشعار محلي اختياري عند تجاوز المعالج / الحرارة / القرص للعتبة (عند الحافة الصاعدة، مع تباطؤ) — محلي، بدون شبكة.
- **حجم نص قابل للتعديل** (عادي / كبير / كبير جدًا) لتحسين الوضوح — القائمة ← حجم النص.
- **واجهة ثلاثية اللغة** (FR / EN / AR): قائمة لغة مدمجة، تبديل فوري، ودعم الكتابة من اليمين لليسار للعربية.
